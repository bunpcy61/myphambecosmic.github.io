...
<body id="reportsPage">
    <div class="" id="home">
        <nav class="navbar navbar-expand-xl">
            <div class="container h-100">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link d-block" href="index.php?controller=login&action=logout">
                                Admin, <b>Logout</b>
                            </a>
                        </li>
                    </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <p class="text-white mt-3 mb-5" style="font-size: 20px;">Welcome back, <b>Admin</b></p>
                </div>
            </div>
            <!-- row -->
                    ...
                    <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-overflow">
                        ...
                        <div class="tm-notification-items">
                            <div class="media tm-notification-item">
                                <div class="tm-gray-circle"><img src="../assets/admin/img/notification-01.jpg" alt="Avatar Image" class="rounded-circle"></div>
                            ...
                            <div class="media tm-notification-item">
                                <div class="tm-gray-circle"><img src="../assets/admin/img/notification-02.jpg" alt="Avatar Image" class="rounded-circle"></div>
                                <div class="media-body">
                            ...
                            <div class="media tm-notification-item">
                                <div class="tm-gray-circle"><img src="../assets/admin/img/notification-03.jpg" alt="Avatar Image" class="rounded-circle"></div>
                                <div class="media-body">
